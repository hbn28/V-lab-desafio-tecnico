...
4. Com `APP_SEED=false`, providencie uma conta operacional por procedimento administrativo antes de testar login. Não habilite contas fictícias em produção nem publique credenciais.
